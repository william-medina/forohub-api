...
public class UserController {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "503", description = "Error al enviar el email de confirmación de cuenta", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "Datos de solicitud inválidos", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
                    @ApiResponse(responseCode = "401", description = "Credenciales inválidas", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
                    @ApiResponse(responseCode = "403", description = "La cuenta no está confirmada", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
                    @ApiResponse(responseCode = "503", description = "Error al reenviar el email de confirmación de cuenta", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
            }
    )
    @PostMapping("/login")
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "503", description = "Error al validar el nombre de usuario con el servicio de IA.", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
            }
    )
